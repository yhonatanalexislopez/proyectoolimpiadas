...
--Prueba de Eliminación en Cascada de manera manual
SELECT * FROM dbo.tblparticipantes
SELECT * FROM dbo.tblpaises
SELECT * FROM dbo.tblresultados
...
--Fin Prueba de eliminación en Cascada de manera manual
...
--para listar los resultados, en éste caso
...
--pero obteniendo el pais desde aquí
...
--Se crea procedimiento almacenado
--para traer el país del participante
